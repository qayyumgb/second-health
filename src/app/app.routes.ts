...
import { ViewDetailComponent } from './modules/admin/dashboards/view-detail/view-detail.component';
    ...
    // Admin routes
    {
        ...
        children: [
            ...
            {path: 'dashboards', children: [
                {path: '', loadChildren: () => import('app/modules/admin/dashboards/dashboard/dashboard.routes')},
            ]},

            // View Detail
            {path: 'dashboards/view-detail', component:ViewDetailComponent},
            ...
            {path: 'apps', children: [
                ...
                {path: 'appname', loadChildren: () => import('app/modules/admin/apps/ecommerce/ecommerce.routes')},
